// Book Details Screen - matches the Goodreads-style layout
// Shows book cover, info, description, reviews, and related books
...
export default function BookDetailsScreen() {
  ...
  const handleStatusChange = () => {
    // Toggle between reading statuses
        ...
        <View style={styles.section}>
          ...
          <View style={styles.relatedBooksGrid}>
            {relatedBooks.map((relatedBook) => (
              <TouchableOpacity key={relatedBook.id} style={styles.relatedBookCard}>
